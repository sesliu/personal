personal.factory("webservicesAula", function($http) {
	...
	var _gerarRelatorioFinanceiro = function(mes,ano,lista) {
		
		return $http.get(url + '/relatorioFinanceiro/'+ mes+'/'+ano+'/'+lista);
	};
	...
	var _excluirAulaFinanceiro = function(idAluno, databanco,diaSemana) {
	...
	return {
		...
		gerarRelatorioFinanceiro:_gerarRelatorioFinanceiro,
		...
		excluirAulaFinanceiro:_excluirAulaFinanceiro
	}
